...
import { Plus, ChevronRight, ArrowDown } from 'lucide-react'

export default function ConvertTab({ chainData, isPreview = false, onSelectToken }) {
  return (
    <>
      ...
      <div className="px-4">
        <Card 
          className="bg-muted/30 p-4 cursor-pointer hover:bg-muted/40 transition-colors"
